...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Derechos de autor 2024 - :current_year, PilzSoft (Registrado en Paraguay). Todos los derechos reservados.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'email'                  => 'Correo electrónico',
                'footer-text'            => '© Derechos de autor 2024 - :current_year, PilzSoft (Registrado en Paraguay). Todos los derechos reservados.',
                'locale'                 => 'Idioma',
        ...
        'datagrid' => [
            ...
            'filters' => [
                ...
                'date-options' => [
                    ...
                    'last-six-months'   => 'Los últimos 6 meses',
                    'last-three-months' => 'Los últimos 3 meses',
                    'this-month'        => 'Este mes',
    ...
    'compare' => [
        ...
        'remove-all-success' => 'Todos los artículos han sido eliminados correctamente.',
    ...
    'checkout' => [
        'success' => [
            'info'          => 'Le enviaremos los detalles de su pedido e información de seguimiento por correo electrónico, ',
            
            'order-id-info' => 'Su número de pedido es #:order_id',
            'thanks' => nl2br('IMPORTANTE: Indicar el número de pedido en el concepto de su transferencia. 
                            El pedido estará vigente durante 48 horas para realizar el depósito/transferencia. 
                            Tenga en cuenta que el horario para TRANSFERENCIA INTERBANCARIA es: 08:00hs a 20:00hs.
    ...
    'errors' => [
        ...
        '404' => [
            'description' => '¡Ups! La página que busca está de vacaciones. Parece que no podemos encontrar lo que está buscando.',
            'title'       => '404 Página no encontrada',
        ],

        '401' => [
            'description' => '¡Ups! Parece que no tiene permiso para acceder a esta página. Parece que le faltan las credenciales necesarias.',
            'title'       => '401 No autorizado',
        ],

        '403' => [
            'description' => '¡Ups! Esta página está prohibida. Parece que no tiene los permisos necesarios para ver este contenido.',
            'title'       => '403 Prohibido',
        ],

        '500' => [
            'description' => '¡Ups! Algo salió mal. Parece que estamos teniendo dificultades para cargar la página que está buscando.',
            'title'       => '500 Error interno del servidor',
        ],

        '503' => [
            'description' => '¡Ups! Parece que estamos fuera de línea temporalmente debido a mantenimiento. Por favor, vuelva más tarde.',
    ...
    'subscription' => [
        'already'             => 'Ya está suscrito a nuestro boletín informativo.',
        'subscribe-success'   => 'Se ha suscrito correctamente a nuestro boletín informativo.',
        'unsubscribe-success' => 'Se ha dado de baja correctamente de nuestro boletín informativo.',
    ],

    'emails' => [
        'dear'   => 'Estimado/a :customer_name',
        'thanks' => 'Si necesita ayuda, no dude en contactarnos en <a href=":link" style=":style">:email</a>.<br/>¡Gracias!',

        'customers' => [
            'registration' => [
                'credentials-description' => 'Su cuenta ha sido creada. Los detalles de su cuenta se encuentran a continuación:',
                'description'             => 'Su cuenta se ha creado con éxito y puede iniciar sesión con su dirección de correo electrónico y contraseña. Después de iniciar sesión, podrá acceder a más servicios, incluida la verificación de pedidos anteriores, listas de deseos y la edición de su información de cuenta.',
            ...
            'verification' => [
                'description'  => 'Haga clic en el botón a continuación para verificar su dirección de correo electrónico.',
                'greeting'     => '¡Bienvenido!',
                'subject'      => 'Correo electrónico de verificación de cuenta',
                'verify-email' => 'Verificar dirección de correo electrónico',
            ],
            ...
            'subscribed' => [
                'description' => '¡Felicidades y bienvenido a nuestra comunidad de boletines informativos! Nos complace tenerte a bordo y mantenerte al día con las últimas noticias, tendencias y ofertas exclusivas.',
                'greeting'    => '¡Bienvenido a nuestro boletín informativo!',
                'subject'     => '¡Usted! Suscribirse a nuestro boletín informativo',
